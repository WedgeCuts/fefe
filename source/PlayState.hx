...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'fefe':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/fefe/dialogue'));
			case 'fefe-too':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/fefe-too/dialogue2'));
			case 'fefeing':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/fefeing/dialogue3'));
			case 'fefecial':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/fefecial/dialogue4'));
		}
			...
			switch (stageCheck)
			{
				...
				case 'schoolEvil':
					...
					case 'fefebg':
					{
						defaultCamZoom = 0.8;
						curStage = 'fefebg';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('fefelol/fefebg','shared'));
		...
		if (isStoryMode)
		{
			switch (StringTools.replace(curSong, " ", "-").toLowerCase())
			{
				...
				case 'thorns':
					schoolIntro(doof);
				case 'fefe' | 'fefe-too' | 'fefeing' | 'fefecial':
					schoolIntro(doof);
				default:
					startCountdown();
			}
	...
	override public function update(elapsed:Float)
	{
		...
		if (runnin == true){
			dad.x += Math.sin(runlol);
			dad.y += Math.sin(runlol);			
	...
	function endSong():Void
	{
		...
		if (offsetTesting)
		{
			FlxG.sound.playMusic(Paths.music('fefemenu'));
			offsetTesting = false;
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					if (curSong == 'Fefe' && !isCutscene)
					{
						FlxG.sound.music.stop();
						video.playMP4(Paths.video('fefe2'), new PlayState()); 
						isCutscene = true;
					}
					if (curSong == 'Fefe Too' && !isCutscene)
					{
						FlxG.sound.music.stop();
						video.playMP4(Paths.video('fefe3'), new PlayState()); 
						isCutscene = true;
					}
					else
					{
	...
	override function beatHit()
	{
		...
		{
			//Trollface
			if (curBeat == 6 || curBeat == 7 || curBeat == 134 || curBeat == 257 || curBeat == 269 || curBeat == 270 || curBeat == 281 || curBeat == 414 || curBeat == 415)
			{
				troll();
			}
			//Fard
			if (curBeat == 46 || curBeat == 48 || curBeat == 166 || curBeat == 265 || curBeat == 276)
			{
				fard();
			}
			//Bruh
			if (curBeat == 22 || curBeat == 110 || curBeat == 156 || curBeat == 204 || curBeat == 260 || curBeat == 265 || curBeat == 263 || curBeat == 404 || curBeat == 430)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.expoOut,});
			}
			//Siren
			if (curBeat == 78 || curBeat == 256 || curBeat == 266 || curBeat == 274 || curBeat == 281)
			{
				sirenlol();
			}
			//Runnin
			if (curBeat == 112 || curBeat == 260)
			{
				trace("startrun");
				runnin = true;
			}
			if(curBeat == 128 || curBeat == 288)
			{
				trace("endrun");
				runnin = false;
			}
			...
			if (curBeat == 292)
			{
			changeDadCharacter('ayoo');
			}
			if (curBeat == 408)
			{
			changeDadCharacter('fefe');
			}
		}
		
		//FEFE TOO ELECTRIC BOOGALOO
		if (curSong == 'Fefe Too')
		{
			//Trollface
			if (curBeat == 104 || curBeat == 108 || curBeat == 152 || curBeat == 216 || curBeat == 230 || curBeat == 231 || curBeat == 294 || curBeat == 295 || curBeat == 300 || curBeat == 302 || curBeat == 303 || curBeat == 337 || curBeat == 472 || curBeat == 476 || curBeat == 479)
			{
				troll();
			}
			//Fard
			if (curBeat == 148 || curBeat == 317 || curBeat == 321 || curBeat == 348 || curBeat == 350 || curBeat == 416 || curBeat == 440 || curBeat == 446)
			{
				fard();
			}
			//Quick Farts
			if (curBeat == 221 || curBeat == 222 || curBeat == 223 || curBeat == 254 || curBeat == 255 || curBeat == 288 || curBeat == 289)
			{
				quickfard();
			}
			//Bruh
			if (curBeat == 144 || curBeat == 151 || curBeat == 284 || curBeat == 286 || curBeat == 323 || curBeat == 326 || curBeat == 329 || curBeat == 333 || curBeat == 335)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.expoOut,});
			}
			//Siren
			/*if (curBeat == 8 || curBeat == 172)
			{
				sirenlol();
			}
			//Runnin
			if (curBeat == 128 || curBeat == 384)
			{
				trace("startrun");
				runnin = true;
			}
			if(curBeat == 144 || curBeat == 400)
			{
				trace("endrun");
				runnin = false;
			}
			if (curBeat % gfSpeed == 0 && runnin == true)
			{
				camHUD.shake(0.02, 0.2);
				FlxG.camera.shake(0.005, 0.2);
			}*/
		...
		{
			//Trollface
			if (curBeat == 12 || curBeat == 45 || curBeat == 47 || curBeat == 86 || curBeat == 87 || curBeat == 115 || curBeat == 208 || curBeat == 276 || curBeat == 284 || curBeat == 420 || curBeat == 428 || curBeat == 429 || curBeat == 472 || curBeat == 474)
			{
				troll();
			}
			//Fard
			if (curBeat == 16 || curBeat == 79 || curBeat == 124 || curBeat == 126 || curBeat == 188 || curBeat == 189 || curBeat == 224 || curBeat == 368 || curBeat == 406 || curBeat == 471 || curBeat == 473)
			{
				fard();
			}
			//Quick Farts
			if (curBeat == 480 || curBeat == 482 || curBeat == 484)
			{
				quickfard();
			}
			//Bruh
			if (curBeat == 247 || curBeat == 414 || curBeat == 470)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.expoOut,});
			}
			//Siren
		...
		{
			//Trollface
			if (curBeat == 0 || curBeat == 8 || curBeat == 16 || curBeat == 24 || curBeat == 124 || curBeat == 192 || curBeat == 400 || curBeat == 408 || curBeat == 416 || curBeat == 424 || curBeat == 648)
			{
				troll();
			}
			//Fard
			if (curBeat == 31 || curBeat == 32 || curBeat == 656 || curBeat == 658)
			{
				fard();
			}
			//Quick Farts
			if (curBeat == 125 || curBeat == 127)
			{
				quickfard();
			}
			//Bruh
			if (curBeat == 22 || curBeat == 30 || curBeat == 422 || curBeat == 430 || curBeat == 496)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.expoOut,});
			}
			//Siren
			if (curBeat == 16 || curBeat == 24 || curBeat == 128 || curBeat == 416 || curBeat == 424)
			{
				sirenlol();
			}
			//Cat
			if (curBeat == 36 || curBeat == 37 || curBeat == 38 || curBeat == 39 || curBeat == 52 || curBeat == 53 || curBeat == 54 || curBeat == 55 || curBeat == 148 || curBeat == 149 || curBeat == 150 || curBeat == 151 || curBeat == 164 || curBeat == 166 || curBeat == 180 || curBeat == 181 || curBeat == 182 || curBeat == 183 || curBeat == 256 || curBeat == 258 || curBeat == 260 || curBeat == 262 || curBeat == 264 || curBeat == 266 || curBeat == 268 || curBeat == 269 || curBeat == 270 || curBeat == 271 || curBeat == 332 || curBeat == 340 || curBeat == 341 || curBeat == 342 || curBeat == 343 || curBeat == 356 || curBeat == 357 || curBeat == 358 || curBeat == 359 || curBeat == 660 || curBeat == 661 || curBeat == 662 || curBeat == 663 || curBeat == 676 || curBeat == 677 || curBeat == 678 || curBeat == 679)
			{
				catlmao();
				if(health > 0.1){
				  health -= 0.09;
				  ...
				  health = 0.01;
				  camHUD.shake(0.05, 0.3);
				  FlxG.camera.shake(0.005, 0.2);
				}
			}
			//LongCat
			if (curBeat == 76 || curBeat == 102 || curBeat == 116 || curBeat == 138 || curBeat == 156 || curBeat == 172 || curBeat == 187 || curBeat == 380 || curBeat == 76){
				longcat();
				ligma = true;
			}
			if (curBeat == 80 || curBeat == 106 || curBeat == 120 || curBeat == 143 || curBeat == 160 || curBeat == 176 || curBeat == 192 || curBeat == 384){
				ligma = false;
			}
			//Runnin
			if (curBeat == 80 || curBeat == 208 || curBeat == 384)
			{
				trace("startrun");
				runnin = true;
			}
			if(curBeat == 96 || curBeat == 224 || curBeat == 400)
			{
				trace("endrun");
				runnin = false;
			}
			//Cam Shake
			if (curBeat % gfSpeed == 0 && ligma == true)
			{
				health -= 0.09;
				camHUD.shake(0.02, 0.2);
				FlxG.camera.shake(0.005, 0.2);
	...
	function troll(){
				var troll:FlxSprite = new FlxSprite();
				troll.loadGraphic(Paths.image('fefelol/le-troll','shared'));
				troll.antialiasing = true;
				troll.active = false;
				troll.scrollFactor.set();
				troll.screenCenter();
				troll.alpha = 0.5;
				troll.scale.set(1.5, 1.5);
				add(troll);
				FlxTween.tween(troll, {alpha: 0},1, {
					ease: FlxEase.cubeInOut,
					onComplete: function(twn:FlxTween)
					{
						troll.destroy();
	...
	function fard(){
				var fard:FlxSprite = new FlxSprite();
				fard.loadGraphic(Paths.image('fefelol/fard','shared'));
				fard.antialiasing = true;
				fard.active = false;
				fard.scrollFactor.set();
				fard.screenCenter();
				fard.alpha = 0.7;
				fard.scale.set(1.5, 1.5);
				add(fard);
				FlxTween.tween(fard, {alpha: 0},1, {
					ease: FlxEase.cubeInOut,
					onComplete: function(twn:FlxTween)
					{
						fard.destroy();
	...
	function quickfard(){
				...
				fard.scale.set(1.5, 1.5);
				add(fard);
				FlxTween.tween(fard, {alpha: 0},0.5, {
					ease: FlxEase.cubeInOut,
					onComplete: function(twn:FlxTween)
					{
						fard.destroy();
	...
	function sirenlol(){
				var siren:FlxSprite = new FlxSprite();
				siren.loadGraphic(Paths.image('fefelol/siren','shared'));
				siren.antialiasing = true;
				siren.active = false;
				siren.scrollFactor.set();
				siren.screenCenter();
				siren.alpha = 0.7;
				siren.scale.set(1.5, 1.5);
				add(siren);
				FlxTween.tween(siren, {alpha: 0},2, {
					ease: FlxEase.cubeInOut,
					onComplete: function(twn:FlxTween)
					{
						siren.destroy();
	...
	function catlmao(){
				var cat:FlxSprite = new FlxSprite();
				cat.loadGraphic(Paths.image('fefelol/fukcigncat','shared'));
				...
				cat.scale.set(2, 2);
				add(cat);
				FlxTween.tween(cat, {alpha: 0},0.7, {
					ease: FlxEase.cubeInOut,
					onComplete: function(twn:FlxTween)
					{
						cat.destroy();
