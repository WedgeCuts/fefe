	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'fefemad':
				tex = Paths.getSparrowAtlas('fefemad','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'fefeidle', 24, false);
				animation.addByPrefix('singUP', 'fefeup', 24, false);
				animation.addByPrefix('singRIGHT', 'feferight', 24, false);
				animation.addByPrefix('singDOWN', 'fefedown', 24, false);
				animation.addByPrefix('singLEFT', 'fefeleft', 24, false);

				//loadOffsetFile(curCharacter);

				playAnim('idle');
			case 'fefe':
				tex = Paths.getSparrowAtlas('fefe_assets','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'fefeidle', 24, false);
				animation.addByPrefix('singUP', 'fefeup', 24, false);
				animation.addByPrefix('singRIGHT', 'feferight', 24, false);
				...
				playAnim('idle');
			case 'ayoo':
				tex = Paths.getSparrowAtlas('PizzaMan','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'PizzasHere', 24, false);
